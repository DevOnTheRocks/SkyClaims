...
public class Metrics {
  ...
  static {
    ...
    if (System.getProperty("bstats.relocatecheck") == null || !System
      ...
      final String defaultPackage = new String(
          new byte[]{'o', 'r', 'g', '.', 'b', 's', 't', 'a', 't', 's', '.', 's', 'p', 'o', 'n', 'g',
              'e'});
      final String examplePackage = new String(
          new byte[]{'y', 'o', 'u', 'r', '.', 'p', 'a', 'c', 'k', 'a', 'g', 'e'});
      // We want to make sure nobody just copy & pastes the example and use the wrong package names
      if (Metrics.class.getPackage().getName().equals(defaultPackage) || Metrics.class.getPackage()
          .getName().equals(examplePackage)) {
  ...
  private JsonObject getServerData() {
    ...
    String spongeImplementation = Sponge.getPlatform()
  ...
  private void writeFile(File file, String text) throws IOException {
    ...
    try (
      ...
      bufferedWriter
          .write("Note: This class only exists for internal purpose. You can ignore it :)");
    }
  }
