...
public class CommandIsland extends CommandBase {
  ...
  private static final Text HELP = LinearComponents.linear("help");
  ...
  public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
    ...
    Text gpInfo = LinearComponents.linear(
        NamedTextColor.WHITE,
        "SkyClaims uses GriefPrevention to provide island protection. Learn more at ",
        Text.builder("http://bit.ly/mcgpuser")
            .color(NamedTextColor.YELLOW)
            .onHover(TextActions.showText(LinearComponents.linear("Click to open")))
            .onClick(gpHelp != null ? TextActions.openUrl(gpHelp) : null),
        NamedTextColor.WHITE, "."
    );

    if (src.hasPermission(Permissions.COMMAND_CREATE)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA,
          Text.builder(alias + "create").onClick(TextActions.runCommand("/" + alias + "create")),
          NamedTextColor.GRAY, " [schematic]",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandCreate.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_ENTITY_INFO)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, Text.builder(alias + "entity").onClick(TextActions.runCommand("/" + alias + "entity")),
          NamedTextColor.GRAY, " [island]",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandEntityInfo.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_EXPAND)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, Text.builder(alias + "expand")
              .onClick(TextActions.suggestCommand("/" + alias + "expand ")),
          NamedTextColor.GRAY, " [island]",
          NamedTextColor.GOLD, " <blocks>",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandExpand.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_DELETE)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, Text.builder(alias + "delete")
              .onClick(TextActions.suggestCommand("/" + alias + "delete")),
          NamedTextColor.GRAY, " [island]",
          NamedTextColor.GRAY,
          src.hasPermission(Permissions.COMMAND_DELETE_OTHERS) ? " [clear]" : Text.EMPTY,
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandDelete.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_DEMOTE)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, Text.builder(alias + "demote")
              .onClick(TextActions.suggestCommand("/" + alias + "demote ")),
          NamedTextColor.GOLD, " <user>",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandDemote.HELP_TEXT
      ));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_HOME)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandHome.HELP_TEXT
      ));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_INFO)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.GRAY, " [island]",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandInfo.HELP_TEXT
      ));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_INVITE)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.GRAY, Text.builder(" [privilege]")
              .onHover(TextActions.showText(getTextFromEnum(PrivilegeType.class))),
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandInvite.HELP_TEXT
      ));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_KICK)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.GOLD, " <user>",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandKick.HELP_TEXT
      ));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_LEAVE)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandLeave.HELP_TEXT
      ));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_LOCK)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandLock.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_PROMOTE)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, Text.builder(alias + "promote")
              .onClick(TextActions.suggestCommand("/" + alias + "promote ")),
          NamedTextColor.GOLD, " <user>",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandPromote.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_RELOAD)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, LinearComponents.linear(TextActions.runCommand("/" + alias + "reload"), alias, "reload"),
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandReload.HELP_TEXT));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_RESET)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandReset.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_SCHEMATIC)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, alias, "schematic",
          NamedTextColor.GRAY, Text.builder(" [sub command]")
              .onHover(TextActions.showText(LinearComponents.linear("list, command, create, delete, info, setbiome, sethieght, seticon, setname, setpreset"))),
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandSchematic.HELP_TEXT));
    }

    if (src.hasPermission(Permissions.COMMAND_SET_BIOME)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, Text.builder(alias + "setbiome")
              .onClick(TextActions.suggestCommand("/" + alias + "setbiome ")),
          NamedTextColor.GOLD, " <biome>",
          NamedTextColor.GRAY, " [target]",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandSetBiome.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_SET_NAME)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, Text.builder(alias + "setname")
              .onClick(TextActions.suggestCommand("/" + alias + "setname ")),
          NamedTextColor.GRAY, " [name]",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandSetName.HELP_TEXT
      ));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_SET_HOME)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandSetHome.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_SET_SPAWN)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, Text.builder(alias + "setspawn")
              .onClick(TextActions.runCommand("/" + alias + "setspawn")),
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandSetSpawn.HELP_TEXT
      ));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_SPAWN)) {
      helpText.add(LinearComponents.linear(
          ...
          NamedTextColor.GRAY, " [player]",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandSpawn.HELP_TEXT
      ));
    }

    if (src.hasPermission(Permissions.COMMAND_TRANSFER)) {
      helpText.add(LinearComponents.linear(
          NamedTextColor.AQUA, alias, "transfer",
          NamedTextColor.GRAY, " [owner]",
          NamedTextColor.GOLD, " <player>",
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandTransfer.HELP_TEXT));
    }
    ...
    if (src.hasPermission(Permissions.COMMAND_LOCK)) {
      helpText.add(LinearComponents.linear(
          ...
          src.hasPermission(Permissions.COMMAND_LOCK_OTHERS) ? " [island|all]" : Text.EMPTY,
          NamedTextColor.DARK_GRAY, " - ",
          NamedTextColor.DARK_GREEN, CommandUnlock.HELP_TEXT
      ));
    }

    if (helpText.isEmpty()) {
      src.sendMessage(LinearComponents.linear(NamedTextColor.AQUA, NAME, " ", VERSION));
    } else {
      if (src instanceof Player) {
        PaginationList.builder()
            .title(LinearComponents.linear(NamedTextColor.AQUA, NAME, " Help"))
  ...
  private Text getTextFromEnum(Class e) {
    ...
    while (it.hasNext()) {
      builder.append(LinearComponents.linear(it.next()));
      if (it.hasNext()) {
        builder.append(LinearComponents.linear(", "));
      }
    }
